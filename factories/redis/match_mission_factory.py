...
#ERROR erro de import conceitual - ta importando MODEL
###ERRO Substituir os raises  por funções validators válidas
#possivel erro em relação a criação do match missions
...
def final_verify_match_mission(match_id, player_id):
    ...
    match match_mission["type"]: #Acho q erro, tem q criar uma lógica pra isso nn?
        case "region":
